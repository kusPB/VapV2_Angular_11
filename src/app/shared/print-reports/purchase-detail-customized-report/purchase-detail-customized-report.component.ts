...
@Component({
  selector: 'app-purchase-detail-customized-report',
  templateUrl: './purchase-detail-customized-report.component.html',
  styleUrls: ['./purchase-detail-customized-report.component.scss']
})
export class PurchaseDetailCustomizedReportComponent implements OnInit {
  environmentData: any;
