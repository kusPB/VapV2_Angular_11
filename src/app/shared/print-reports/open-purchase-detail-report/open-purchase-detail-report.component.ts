...
@Component({
  selector: 'app-open-purchase-detail-report',
  templateUrl: './open-purchase-detail-report.component.html',
  styleUrls: ['./open-purchase-detail-report.component.scss']
})
export class OpenPurchaseDetailReportComponent implements OnInit {
  environmentData: any;
