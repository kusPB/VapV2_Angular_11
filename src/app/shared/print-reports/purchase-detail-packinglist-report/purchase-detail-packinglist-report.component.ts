...
@Component({
  selector: 'app-purchase-detail-packinglist-report',
  templateUrl: './purchase-detail-packinglist-report.component.html',
  styleUrls: ['./purchase-detail-packinglist-report.component.scss']
})
export class PurchaseDetailPackingListReportComponent implements OnInit {
  environmentData: any;
